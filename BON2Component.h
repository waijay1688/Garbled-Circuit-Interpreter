...
class Component
{
	...
	private:
		void setBasicInfo(const GarbledCircuit_BON::GarbledCircuit& gc);
		void setInit(const GarbledCircuit_BON::GarbledCircuit& gc);
		void setFixedValue(const GarbledCircuit_BON::GarbledCircuit& gc);
		void setInputOutput(const GarbledCircuit_BON::GarbledCircuit& gc);
		void setConnection(const GarbledCircuit_BON::GarbledCircuit& gc);
	public:
		Component();
		~Component();
	...
	public:
		...
		void traversalProject(Project& project);
		void traversalGarbledCircuit(const GarbledCircuit_BON::GarbledCircuit& gc);
	#ifdef GME_ADDON
